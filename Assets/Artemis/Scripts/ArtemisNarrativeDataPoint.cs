...
{ 
    ...
    public void Rewrite(string _id, ArtemisPreDictionarySystem _systemScriptable, int _priorityValue, ArtemisFlag[] _flagsToMeet, ArtemisFlag[] _flagsToAvoid, WhenAlreadyVoicePlaying _whenAlreadyVoicePlaying)
    {
        id = _id;

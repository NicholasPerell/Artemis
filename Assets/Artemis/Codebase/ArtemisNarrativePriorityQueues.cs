...
public class ArtemisNarrativePriorityQueues : ScriptableObject
{
    ...
    [Space]
    [SerializeField]
    ArtemisPriorityQueue<ArtemisNarrativeDataPoint> priorityQueue; //for reactivity and recency. Priority value > 0
    [SerializeField]
    ...
    void Refresh(bool includePriorityQueue)
    {
        ...
        priorityQueue = new ArtemisPriorityQueue<ArtemisNarrativeDataPoint>(true);
    ...
    public void RecieveDataPoint(ArtemisNarrativeDataPoint dataPoint)
    {
